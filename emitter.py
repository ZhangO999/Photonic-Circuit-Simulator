...
class Emitter:
    ...
    def set_pulse_sequence(self, frequency: int, direction: str) -> None:
        ...
        '''
        if frequency > 0 and (
                direction == "N" or direction == "E" or direction == "S" or direction == "W"):
    ...
    def __str__(self) -> str:
        ...
        C: 256THz, South
        '''
        # convert cardinal directions to full words:
        if self.direction == "N":
        ...
        return f"{self.symbol}: {self.frequency}THz, {direction_word}"
